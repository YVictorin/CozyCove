...
const MultiStepForm = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
      ...
      {/* Step Indicator */}
      <div className={`w-full mt-24 max-w-3xl mb-4 px-4 flex items-center justify-between`}>
      <div>
          {currentStep > 1 ? (
          ...
          <div className="p-8">
            ...
            <div className="flex justify-end">
              <button
                ...
                className={`px-6 py-3 rounded-md text-white font-medium transition-all cursor-pointer ${
