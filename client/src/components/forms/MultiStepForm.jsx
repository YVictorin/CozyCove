...
const MultiStepForm = () => {
  ...
  // Function to submit registration data to the backend and redirect on success
      ...
      <div className="bg-white rounded-lg shadow-md w-full max-w-3xl overflow-hidden relative">
          ...
          <div className="p-8">
            ...
            <div className="flex justify-end">
              <button 
                ...
                className={`px-6 py-3 rounded-md text-white font-medium transition-all ${formData.needType ? 'bg-blue-600 hover:bg-blue-700' : 'bg-gray-300 cursor-not-allowed'}`}
              >
                Next step
              </button>
            </div>
          ...
          <div className="p-8">
            ...
            <div className="flex justify-end">
              <button 
                ...
                className={`px-6 py-3 rounded-md text-white font-medium transition-all ${formData.name && formData.email ? 'bg-blue-600 hover:bg-blue-700' : 'bg-gray-300 cursor-not-allowed'}`}
              >
                Next step
              </button>
            </div>
          ...
          <div className="p-8">
            ...
            <div className="flex justify-end">
              <button 
                ...
                className={`px-6 py-3 rounded-md text-white font-medium transition-all ${formData.password && formData.confirmPassword && formData.password === formData.confirmPassword ? 'bg-blue-600 hover:bg-blue-700' : 'bg-gray-300 cursor-not-allowed'}`}
              >
                Next step
              </button>
            </div>
        ...
        <div className={`transition-all duration-300 ${animation} ${currentStep === 4 ? 'block' : 'hidden'}`}>
          <div className="p-8">
            ...
            <p className="text-center text-gray-500 mb-8">Review your information before completing registration</p>
            ...
            <div className="bg-gray-50 p-4 rounded-md mb-6">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium">{formData.needType ? formData.needType.replace(/([A-Z])/g, ' $1').replace(/^./, str => str.toUpperCase()) : '—'}</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-end">
              <button 
                ...
                className={`px-6 py-3 rounded-md text-white font-medium transition-all ${formData.agreeTerms ? 'bg-blue-600 hover:bg-blue-700' : 'bg-gray-300 cursor-not-allowed'}`}
              >
