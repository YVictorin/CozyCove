...
const Parents = () => {
  ...
  // Scrolls to the section specified when the page loads
  useEffect(() => {
  ...
  return (
    <div className="relative flex flex-col min-h-screen bg-gradient-to-b from-[#c7fcfb] via-[#d3fffe] via-[#d3fffe] to-[#fbedca]">
      ...
      <nav className="relative z-50">{/* Navbar content goes here */}</nav>
      ...
      <div className="bg-[#f9f9f9] py-3 md:py-16 text-center mb-6 md:mb-10 rounded-md md:rounded-3xl shadow-lg relative overflow-hidden w-full mt-30 md:mt-64">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-2 md:px-4">
          <h1 className="text-lg md:text-5xl font-bold text-[#FA507E] mb-1 md:mb-5 text-shadow-md">
            GROWN-UPS
          </h1>
          <p className="text-xs md:text-xl mb-1 md:mb-8 text-[#666666] px-1 md:px-0">
            Supporting parents, caregivers, and educators with tools,
            strategies, and a community to help your child thrive.
          </p>
        </div>
      </div>
      ...
      <main className="max-w-6xl mx-auto px-3 md:px-4 py-4 md:py-8 w-full">
        ...
        <section className="bg-[#f9f9f9] p-4 md:p-8 rounded-md md:rounded-3xl shadow-md mb-6 md:mb-10">
          <div className="text-center mb-1 md:mb-8">
            <h2 className="text-base md:text-4xl font-semibold text-[#26A5B3] mb-1 md:mb-4">
              Welcome to Our Resource Center
            </h2>
            <p className="text-xs md:text-lg text-[#666666]">
              We understand that raising a neurodivergent child comes with
              unique joys and challenges. Our resource center is designed to
              provide you with information, practical tools, and supportive
              community resources.
            </p>
          </div>
        </section>
        ...
        <section className="mb-2 md:mb-10">
          <h2 className="text-sm md:text-3xl font-semibold text-[#FA507E] mb-4 md:mb-6 px-1">
            Resource Categories
          </h2>
        ...
        <section
          id="visual-schedule"
          className="bg-[#f9f9f9] p-1 md:p-8 rounded-md md:rounded-3xl shadow-md mb-2 md:mb-10"
        >
          <h2 className="text-sm md:text-3xl font-semibold text-[#26A5B3] mb-1 md:mb-4">
        ...
        <section className="bg-[#f9f9f9] p-2 md:p-8 rounded-md md:rounded-3xl shadow-md mb-6 mt-6 md:mb-10">
          <h2 className="text-sm md:text-3xl font-semibold text-[#FA507E] mb-1 md:mb-6">
          ...
          <div className="max-w-3xl mx-auto">
            {faqData.map((faq, index) => (
              <div
                key={index}
                className="border-b border-[#999999] py-1 md:py-4"
              >
                <h3
                  className={`text-xs md:text-xl font-semibold cursor-pointer flex justify-between items-center ${
                    activeFaq === index ? "text-[#6EE4DE]" : "text-[#26A5B3]"
                  }`}
                ...
                {activeFaq === index && (
                  <p className="mt-1 md:mt-2 text-xs md:text-base text-[#666666]">
                    {faq.answer}
                  </p>
                )}
              </div>
