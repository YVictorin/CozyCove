...
const Explore = () => {
    ...
    return (
        <div className="relative flex flex-col min-h-screen bg-gradient-to-b from-[#c7fcfb] via-[#d3fffe] via-[#d3fffe] to-[#fbedca]">
            ...
            {/* Hero Section */}
            <div className="bg-[#f9f9f9] py-16 text-center mb-10 rounded-3xl shadow-lg relative overflow-hidden w-full mt-64">
            ...
            <main className="max-w-6xl mx-auto px-4 py-8">
                {/* Welcome Section */}
                <section className="bg-[#f9f9f9] p-8 rounded-3xl shadow-md mb-10">
                    ...
                    <div className="relative flex items-center">
                        ...
                        >
                            {categoryCards.map((card, index) => (
                               ...
                               link={card.link}
                               cardStyle="bg-[#f8f8ff] border-4 border-white outline-4 outline-[#6fd5ea] 
                                          shadow-lg transform transition-all hover:scale-105 hover:shadow-xl
